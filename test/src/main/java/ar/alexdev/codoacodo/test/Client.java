...
public class Client {
    ...
    public static void run() {
        ...
        while(!Objects.equals(opc, "5")) {
            ...
            System.out.println("| (2) Filtrar libros por título    |");
            System.out.println("| (3) Filtrar libros por autor     |");
            System.out.println("| (4) Filtrar libros por editorial |");
            System.out.println("| (5) Salir                        |");
            System.out.println("------------------------------------");
            System.out.print("-- Ingrese una opción: ");
            opc = scanner.nextLine();
            if(Objects.equals(opc, "1")) listAllBooks(FindBookServiceImpl.newInstance(ArrayRepository.newInstance()));
            if(Objects.equals(opc, "2")) listBooksByTitle(FindBookServiceImpl.newInstance(ArrayRepository.newInstance()));
            if(Objects.equals(opc, "3")) listBooksByAuthor(FindBookServiceImpl.newInstance(ArrayRepository.newInstance()));
            if(Objects.equals(opc, "4")) listBooksByEditorial(FindBookServiceImpl.newInstance(ArrayRepository.newInstance()));
        }
    }
